...
suspend fun getBubbleTimeline(
	...
	if (getFeature("bubble_timeline_chuckya")) {
		return getPublicTimeline(maxId = maxId, minId = minId, sinceId = sinceId, bubble = true)
	}
	...
	val req = httpClient.get("https://$host/api/v1/timelines/bubble") {
